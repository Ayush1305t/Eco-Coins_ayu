...
const Impact = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
      ...
      >
        <h1 className="text-4xl md:text-6xl font-extrabold dark:text-white text-slate-900 mb-6 tracking-tight">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
        {[
          ...
          <motion.div 
            ...
            className={`glass p-8 rounded-3xl flex flex-col items-center justify-center text-center group transition-all duration-300 ${stat.glow} hover:-translate-y-2`}
          >
            ...
            <p className="text-4xl md:text-5xl font-black dark:text-white text-slate-900 mb-3">{stat.value}</p>
      ...
      >
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 border-b border-black/10 dark:border-white/10 pb-6 gap-4">
          ...
          <div className="glass px-4 py-2 rounded-lg text-sm font-medium dark:text-slate-300">
        ...
        <div className="space-y-4">
          {[1, 2, 3, 4, 5].map((i) => (
            <motion.div 
              ...
              key={i} 
              className="flex items-center gap-4 md:gap-6 p-4 rounded-2xl glass hover:bg-white/50 dark:hover:bg-white/10 transition-all duration-300 transform hover:scale-[1.01]"
            >
