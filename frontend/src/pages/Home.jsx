      ...
      <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24 flex flex-col-reverse lg:flex-row items-center gap-16">
        <div className="flex-1 space-y-8 z-10">
          ...
          >
            ...
            <Link to="/impact" className="px-8 py-4 rounded-xl glass hover:bg-white/40 dark:hover:bg-white/10 font-bold text-lg transition-all flex items-center gap-2 hover:-translate-y-1 text-slate-800 dark:text-white">
              View Impact
            </Link>
          </motion.div>
        </div>
