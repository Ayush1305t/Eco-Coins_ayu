...
const Contact = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full flex flex-col lg:flex-row gap-16 relative overflow-hidden">
      ...
      >
        <div>
          <h1 className="text-5xl md:text-6xl font-extrabold dark:text-white text-slate-900 mb-6 tracking-tight">Get in Touch</h1>
        ...
        <div className="space-y-6">
          <motion.div whileHover={{ scale: 1.02 }} className="flex items-center gap-6 glass p-6 rounded-3xl transition-transform">
            ...
            <div>
              ...
              <p className="text-lg font-bold text-slate-900 dark:text-white">ayush1313tiwari@gmail.com</p>
            </div>
          </motion.div>
          <motion.div whileHover={{ scale: 1.02 }} className="flex items-center gap-6 glass p-6 rounded-3xl transition-transform">
            ...
            <div>
              ...
              <p className="text-lg font-bold text-slate-900 dark:text-white leading-tight">Kcc Institute of Technology <br/>and Management</p>
            </div>
          </motion.div>
          <motion.div whileHover={{ scale: 1.02 }} className="flex items-center gap-6 glass p-6 rounded-3xl transition-transform">
            ...
            <div>
              ...
              <p className="text-lg font-bold text-slate-900 dark:text-white">+916306055008</p>
            </div>
          </motion.div>
        </div>
      </motion.div>
      ...
      >
        <div className="glass p-8 md:p-12 rounded-3xl relative overflow-hidden">
          ...
          <h2 className="text-3xl font-bold dark:text-white text-slate-900 mb-8 relative z-10">Send us a Message</h2>
